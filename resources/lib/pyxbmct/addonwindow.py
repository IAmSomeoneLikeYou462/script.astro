...
class AddonWindow(AbstractWindow):
    ...
    def setGeometry(self, width_, height_, rows_, columns_, pos_x=-1, pos_y=-1, padding=5):
        ...
        super(AddonWindow, self).setGeometry(
            width_, height_, rows_, columns_, pos_x, pos_y)
        ...
        self.title_background.setPosition(
            self.x + skin.x_margin, self.y + skin.y_margin + skin.title_back_y_shift)
    ...
    def _setGrid(self):
        ...
        self.grid_y = self.y + skin.y_margin + skin.title_back_y_shift + \
            skin.header_height + self.win_padding
        self.tile_width = (self.width - 2 * (skin.x_margin +
                           self.win_padding)) // self.columns
